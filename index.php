        ...
        <div class="container-fluid d-flex justify-content-between">
            ...
            <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="btn btn-outline-secondary ml-2 mb-2" href="./pages/public/signin.php"
                            style="width: 90%;">
                            Login
                        </a>
                    </li>
                    ...
                    <div class="container px-4 px-lg-5 h-100">
                        <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                            ...
                            <div class="col-lg-8 align-self-baseline">
                                <p class="font-weight-normal lead mb-4">Transforma o caos em clareza! Com o T-Master
                                    poderás
                                    categorizar,
                                    priorizar e partilhar as tuas tarefas. Define Estados, destaca as tuas tarefas
                                    favoritas e simplifica
                            ...
                            <div class="media-content">
                                ...
                                <div class="text-right text-dark pb-3">
                                    <p class="font-weight-normal lead mb-4">
                                        Bem-vindo ao T-Master, a tua solução completa para gestão de tarefas de forma
                                        eficiente e
                                        intuitiva! Na nossa jornada para simplificar a tua vida profissional e pessoal,
                                        oferecemos
                                        uma plataforma robusta que permite aos utilizadores organizarem tarefas,
                                        definirem
                                        prioridades e colaborarem de forma eficaz. <br> Junta-te a nós e otimiza a tua
                                        produtividade!
                                    </p>
                                </div>
                            </div>
                    ...
                    <div class="row gx-4 gx-lg-5 justify-content-center">
                        <div class="col-lg-3 col-md-6 text-center mb-5">
                            <div class="mt-5">
                                ...
                                <p class="text-muted mb-0">Poderás priorizar as tuas tarefas de modo a aumentar a tua
                                    produtividade e atingires os teus objetivos com facilidade.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 text-center">
                            <div class="mt-5">
                                ...
                                <p class="text-muted mb-0">Conseguirás partilhar as tuas tarefas, e acompanhar em tempo
                                    real as tarefas
                        ...
                        <div class="col-lg-3 col-md-6 text-center">
                            <div class="mt-5">
                                ...
                                <p class="text-muted mb-0">Serás capaz de calendarizar as tuas tarefas e fazer um
                                    planeamento a longo
                        ...
                        <div class="col-lg-3 col-md-6 text-center">
                            <div class="mt-5">
                                ...
                                <p class="text-muted mb-0">Terás o poder de favoritar as tuas tarefas, o que te ajudará
                                    a concentrares
